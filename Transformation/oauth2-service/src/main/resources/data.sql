   ...
   insert into permission(permission_id,permission_name) values(9,'read_dashboard');
...
INSERT INTO USER (user_id,user_name,password,contact_number ,rating,role_role_id) VALUES (
   ...
   insert into role_permission (role_id,permission_id) values (2,6); -- role admin and permission - read_utility
...
VALUES
	...
	36000, 
	36000,
	'user-resource,utility-resource,oauth2-resource,dashboard-resource,test-resource,transformation-resource',null,'false'
	);
...
VALUES
	...
	36000, 
	36000,
	'user-resource,utility-resource,zuul-resource,oauth2-resource,dashboard-resource,test-resource,transformation-resource',null,'false'
	);
